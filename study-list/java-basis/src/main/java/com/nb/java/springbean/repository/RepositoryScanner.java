 ...
 * @author: duanshouzhi
 * @create: 2023-06-13 11:48
 * @description: 按类型动态注入Repository代理类
 **/
@Configuration
public class RepositoryScanner implements BeanDefinitionRegistryPostProcessor, ResourceLoaderAware, ApplicationContextAware {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry beanDefinitionRegistry) throws BeansException {
        ...
        for (Class beanClazz : beanClazzSet) {
            ...
            definition.setBeanClass(NvRepositoryFactoryBean.class);
    ...
    private boolean isNotNeedProxy(Class beanClazz) {
        ...
        return !beanClazz.isInterface()
                || beanClazz.getInterfaces().length <= 0
                || beanClazz.getInterfaces()[0] != NvRepository.class
                || null == AnnotatedElementUtils.findMergedAnnotation(beanClazz, NeedProxy.class);
    }
